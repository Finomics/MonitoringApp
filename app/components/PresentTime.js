    ...
    const handlePunchOut=() =>{
        ...
        Alert.alert(
            ...
            [
              ...
              { 
                text: "OK", 
                onPress: () => {console.log("OK Pressed"), handleFirebase('punchOut')} 
            }
    ...
    const handlePunchIn=() =>{
        ...
        Alert.alert(
            ...
            [
              ...
              { 
                text: "OK", 
                onPress: () => {console.log("OK Pressed"), handleFirebase('punchIn')} 
            }
    ...
    const handlePress=() =>{
        ...
        Alert.alert(
            ...
            //   { text: "OK", onPress: () => {console.log("OK Pressed")} }
              { 
                text: "OK", 
                onPress: () => {console.log("OK Pressed"), handleFirebase()} 
            }
        ...
        <Screen>
            ...
            <View style={styles.mapContainer}>
                ...
                >
                    ...
                    />
                    <Marker
                        coordinate={{ latitude : mapInputLocation.latitude , longitude : mapInputLocation.longitude }}
                    />
                </MapView>
            </View>
        </Screen>
